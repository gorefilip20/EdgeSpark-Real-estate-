...
function InternationalProspectingPanel() {
  ...
  const selectBusiness = (business: any) => { setSelectedBusiness(business); setDraft(null); const hasContact = Boolean(business.phone || business.email || business.website || business.contactName || business.contactRole); setContactProfile(hasContact ? { contactName: business.contactName || null, contactRole: business.contactRole || "Business Development / Partnerships team", email: business.email || null, phone: business.phone || null, website: validHttpUrl(business.website), sourceUrl: validHttpUrl(business.website) || validHttpUrl(business.mapsUrl), publicSummary: null } : null); };
